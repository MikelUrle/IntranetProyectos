...
// Servlet para editar los proyectos
@WebServlet("/admin_editar_proyectos")
public class admin_editar_proyectos extends HttpServlet implements Rutas_conexion{
	private static final long serialVersionUID = 1L;
       

    public admin_editar_proyectos() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Llamamos a EditarProyectos.jsp
		request.getRequestDispatcher(JSP_ADMIN_EDITAR_PROYECTOS).forward(request, response);
