...
// Servlet para ir a la zona de administracion de proyectos
@WebServlet("/AdminProyectos")
public class AdminProyectos extends HttpServlet implements Rutas_conexion{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Llamamos a admin_proyectos_usuario.jsp
		request.getRequestDispatcher(JSP_ADMIN_PROYECTOS).forward(request, response);
	}
