...
int Id = 0;
if(request.getAttribute(Rutas_conexion.ATR_VAR_DATO_ID_OBJETIVO) != null) {
	Id = (int)request.getAttribute(Rutas_conexion.ATR_VAR_DATO_ID_OBJETIVO);

} else {
	out.println("Error de atributos");
	out.println("No llego el atributo ATR_VAR_DATO_ID_OBJETIVO");
}
		...
		<div class="container-fluid" id ="navbarEspecifico">
			...
			<div class="collapse navbar-collapse" id="navbarNav" style="margin-left: 50vw">
				<ul class="navbar-nav">
					...
					<li class="nav-item" style="margin-left: 2vw">
						<a class="textoNav nav-link" href="admin_solicitudes">Solicitudes</a>
					</li>
					<li class="nav-item" style="margin-left: 2vw">
						<a href="deslogin">
...
>
    ...
    <tbody>
        ...
        <form method="post" action="admin_modificar_objetivo_unico" >
	        <tr>
	            <td>
	            	<p>AN</p>
	            </td>
	            ...
	            <td>
		            <div class="form-floating">
					  <textarea class="form-control" placeholder="Leave a comment here" name="persona"><%=elemento.getPersona() %></textarea>
					</div>
	            </td>
	            <td>
		            <div class="form-floating">
					  <textarea class="form-control" placeholder="Leave a comment here" name="prioridad"><%=elemento.getPrioridad() %></textarea>
					</div>
	            </td>
	        ...
	        <input type="hidden" name="idProyecto" value="<%= elemento.getProyecto() %>">
	        <input type="hidden" name="idObjetivo" value="<%= Id %>">
        </form>
