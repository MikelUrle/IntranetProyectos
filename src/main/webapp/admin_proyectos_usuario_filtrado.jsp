...
<%
// Para mandarte al login si no hay ningunsa sesion activa
...
if(request.getAttribute(Rutas_conexion.ATR_VAR_DATO) != null) {
	primerId = (int)request.getAttribute(Rutas_conexion.ATR_VAR_DATO);

} else {
	out.println("Error de atributos");
	out.println("No llego el dato");
}
...
<div style="width: 50vw">  
    <main style="margin-left: 6vw; margin-bottom: -6vh">
		...
		<div id="des">
			...
			<%for(Proyecto elemento: listaProyectos) {%>
			<% if(elemento.getId()==primerId){%>
			  <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 24vh; width: 41.5vw; margin-left: 6vw; margin-top: 8vh" readonly>
...
<div style="width: 50vw">
		<div style="display: flex">
			...
			<button type="button" class="btn btn-dark" id="botonEditarProyecto" style="width: 15%">Editar</button>
		</div>
