...
List<CheckkAll> listaCheckkAllFiltrado = new ArrayList<>();
if(request.getAttribute(Rutas_conexion.ATR_LISTA_CHECKKALL_FILTRADO) != null) {
	listaCheckkAllFiltrado = (List<CheckkAll>)request.getAttribute(Rutas_conexion.ATR_LISTA_CHECKKALL_FILTRADO);

} else {
	out.println("Error de atributos");
	out.println("No llego el atributo atr_lista_checkkall_filtrado");
}
...
>
    ...
    <tbody>
		...
		for(CheckkAll elemento: listaCheckkAllFiltrado) {	
